({
  steps: {
    hello: {
      ...
      superPos: true,
      text: `
        Поздравляю, ты начал многопользовательскую партию игры с колодой Банкинг. Пока ты ждешь подключения других игроков, я готов рассказать об интерфейсе игры.
      `,
      actions: {
        before: ({ $root }) => {
    ...
    helloSingle: {
      text: `
        Поздравляю, ты начал однопользовательскую партию игры с колодой Банкинг. Я готов рассказать об интерфейсе игры.
      `,
      superPos: true,
      actions: {
        before: ({ $root }) => {
